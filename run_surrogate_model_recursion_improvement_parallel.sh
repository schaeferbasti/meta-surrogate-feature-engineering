...
datasets=(359963 359968 359971 359972 359974 359975 359979 359981 359982 359983 359987 359992 359993)d
...
python3 src/SurrogateModel/SurrogateModel_TabArena_Recursion_Improvement_Parallel.py  --dataset "$dataset" # "$SLURM_ARRAY_TASK_ID" "$*"
