...
from src.utils.run_models import get_model_score_regression, run_autogluon_lgbm_regression, get_model_score
...
def continue_calculating_improvement_regression(result_matrix, dataset, path):
...
def main(dataset):
    ...
    try:
        ...
        if check:
            ...
            continue_calculating_improvement_regression(result_matrix, dataset, path)
