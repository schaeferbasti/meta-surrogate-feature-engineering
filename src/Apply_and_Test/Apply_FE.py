...
def get_additional_features(data, prediction_result):
    ...
    for additional_feature in additional_feature_list:
        ...
        if len(original_features) == 2:
            feature, featurename = create_feature_and_featurename(data[original_features[0]], data[original_features[1]],
                                                        operation)
        else:
            feature, featurename = create_feature_and_featurename(data[original_features[0]], None, operation)
